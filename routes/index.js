...
router.get('/schedule', function(req, res, next) {
   res.render('schedule', { title: 'Express', Subject: [
      ...
      },
      {
         'id': 'python',
         'title': 'Python',
         'text': 'Python是一種相當容易入門的程式語言，屬於直譯式，不同於如C++等編譯式語言，不需安裝編譯環境，執行起來較為快速，又因Python有統一的撰寫格式，可讀性高，語法簡單，又有大量現成函式庫可供使用，因此成為美國小學教學程式的大熱門，Google等公司也用Python製作了許多程式如YouTube 。',
         'img': 'python.jpg'
      },
      {
         'id':'aviutl',
